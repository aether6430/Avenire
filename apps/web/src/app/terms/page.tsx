  ...
  return (
    <MarketingPageShell showDividerAfterNav>
      <MarketingPageFrame
        ...
        frameClassName="border-t-0"
        sectionClassName="pb-20 pt-28 sm:pt-32"
      >
        ...
        <p className="mt-4 max-w-2xl text-balance text-sm text-white/62 leading-7 md:text-base">
          ...
          intentionally short and readable so you can find the parts that matter
          without digging through legal noise.
        </p>
