export const faqs = [
  ...
  },
  {
    ...
    answer:
      "It can be your main study workspace, but it also works well as an AI layer for turning source material into structured notes, explanations, and review plans.",
  },
  {
    question: "Can I cancel or change plans?",
    answer:
      "Yes. Plans are meant to be simple, and you can move between them as your usage changes.",
  },
];
