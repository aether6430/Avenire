...
export const TextToWorkflowBuilderSkeleton = () => {
  const initialChat = [
    ...
    },
    {
      role: "user",
      content:
        "Can you turn this lecture note into a study plan and Mindset Sets?",
    },
    {
      role: "assistant",
      content:
  ...
  return (
    <div className="flex justify-end gap-3">
      <div className="flex max-w-xs flex-col gap-1">
        <div className="rounded-2xl rounded-br-md bg-brand px-4 py-2 text-[var(--primary-foreground)] text-sm">
...
const VerticalLine = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      className="shrink-0"
      fill="none"
...
const RightSideSVG = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      fill="none"
      height="2"
...
const TopSVG = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      fill="none"
      height="33"
...
const MiddleSVG = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      fill="none"
      height="2"
...
const BottomSVG = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      fill="none"
      height="32"
