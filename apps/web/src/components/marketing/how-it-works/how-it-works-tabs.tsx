  ...
  return (
    <>
      <div className="mt-16 hidden w-full grid-cols-2 divide-x divide-divide border-divide border-t lg:grid">
        ...
        <div className="mask-r-from-90% mask-l-from-90% mask-radial-from-20% relative h-full max-h-[370px] overflow-hidden bg-[repeating-linear-gradient(315deg,_var(--pattern-fg)_0,_var(--pattern-fg)_1px,_transparent_0,_transparent_50%)] bg-[size:12px_12px]">
