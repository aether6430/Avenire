...
interface FilePreviewMarkdownCoverSectionProps {
...
export function FilePreviewMarkdownCoverSection({
...
}: FilePreviewMarkdownCoverSectionProps) {
                ...
                <Popover>
                  ...
                  >
                    <div className="flex items-center justify-between border-border/60 border-b px-3 py-2">
                      <Tabs
                        onValueChange={(value) =>
                          onNoteCoverPickerTabChange(value as MarkdownCoverTab)
                        }
                          ...
                          <div className="grid grid-cols-4 gap-2">
                            {NOTE_COVER_GALLERY.map((option) => (
                              <button
                                ...
                                key={option.label}
                                onClick={() => onSetNoteCoverUrl(option.url)}
                                type="button"
                              >
                                <Image
                                  alt={option.label}
                        ...
                        <div className="space-y-3">
                          <input
                            ...
                            onKeyDown={(event) => {
                              ...
                              const nextUrl = noteCoverLinkDraft.trim();
                              if (!nextUrl) {
                                return;
                              }
                          ...
                          <div className="flex justify-end">
                            <Button
                              className="h-8 rounded-md px-3 text-xs"
                              disabled={noteCoverLinkDraft.trim().length === 0}
                              onClick={() =>
                                onSetNoteCoverUrl(noteCoverLinkDraft.trim())
                              }
                              size="sm"
                              type="button"
                            >
