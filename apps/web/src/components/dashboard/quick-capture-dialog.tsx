...
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@avenire/ui/components/tabs";
...
export function QuickCaptureDialog({
  ...
  return (
    <Dialog onOpenChange={setOpen} open={open}>
      ...
      <DialogContent largeWidth className="max-w-5xl">
        <DialogHeader className="space-y-2">
          <DialogTitle>Quick capture</DialogTitle>
          <DialogDescription>
            Capture a task, note, or misconception without leaving the page.
          </DialogDescription>
        </DialogHeader>

        <Tabs onValueChange={(value) => setKind(value as CaptureKind)} value={kind}>
          <TabsList className="grid w-full grid-cols-3">
            <TabsTrigger value="task">Task</TabsTrigger>
            <TabsTrigger value="note">Note</TabsTrigger>
            <TabsTrigger value="misconception">Misconception</TabsTrigger>
          </TabsList>

          <TabsContent className="mt-4 space-y-4" value="task">
          ...
          <TabsContent className="mt-4 space-y-4" value="note">
          ...
          <TabsContent className="mt-4 space-y-4" value="misconception">
            <div className="space-y-4">
