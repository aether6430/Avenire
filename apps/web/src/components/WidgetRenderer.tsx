...
//
// ---------------------------------------------------------------------------
// How to extract widget HTML from an AI stream (Vercel AI SDK example)
// ---------------------------------------------------------------------------
//
// The AI outputs a <widget> tag wrapping the HTML fragment:
//
//   <widget>
//   <style>...</style>
//   <div>...</div>
...
//   </widget>
//
// Parse it from the stream:
//
//   function extractWidget(text: string): { widget: string | null; prose: string } {
//     const match = text.match(/<widget>([\s\S]*?)<\/widget>/);
//     if (!match) return { widget: null, prose: text };
//     return {
//       widget: match[1].trim(),
