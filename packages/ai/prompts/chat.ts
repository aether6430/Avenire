...
export function APOLLO_PROMPT(
  ...
  return [
    ...
    "When you identify an active misconception in the same topic, check whether relevant cards from that Mindset Set are already due. If due cards exist, explicitly tell the user to revise them now or next.",
