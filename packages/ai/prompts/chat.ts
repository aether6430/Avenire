...
export function APOLLO_PROMPT(
  ...
  return [
    ...
    "- list_files: List workspace files. Use this first to discover file IDs and folder paths.",
    "- read_file: Read file content by file ID.",
    "- move_file: Move a file to a different folder by file ID.",
    ...
    "2. Then pass the real file ID to read_note, update_note, or update_note_tags.",
    "3. Use create_note when the user asks to write a new note — provide the title and content explicitly, do not leave it to the AI to draft.",
