...
export const Spinner = forwardRef<SVGSVGElement, SpinnerGlyphProps>(
...
export const ThinkingIndicator = forwardRef<HTMLDivElement, SpinnerProps>(
  function ThinkingIndicator({ className, messages, ...props }, ref) {
    ...
    const safeIndex = index % resolvedMessages.length;
        ...
        <span className="inline-grid overflow-hidden font-medium text-[13px]">
          ...
          <AnimatePresence initial={false} mode="popLayout">
            <motion.span
              ...
              key={resolvedMessages[safeIndex]}
            >
              {resolvedMessages[safeIndex]}
            </motion.span>
          </AnimatePresence>
        </span>
      </div>
...
export const ThinkingGlyph = SpinnerGlyph;
