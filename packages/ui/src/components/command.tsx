...
function CommandRoot({
  ...
  return (
    <CommandPrimitive
      data-slot="command"
      className={cn(
        "flex size-full flex-col overflow-hidden rounded-xl! border border-white/[0.08] bg-popover/92 p-1 text-popover-foreground shadow-2xl shadow-black/30 backdrop-blur-xl supports-[backdrop-filter]:bg-popover/88",
        className
      )}
      {...props}
    />
...
function CommandPreview({
  ...
  return (
    <aside
      ...
      className={cn(
        "hidden min-h-0 overflow-hidden rounded-lg border border-white/[0.08] bg-black/55 shadow-xl shadow-black/10 backdrop-blur-md md:block",
        className
      )}
      {...props}
    />
