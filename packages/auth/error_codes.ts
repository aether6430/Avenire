...
const errorCodes = {
  ...
  ACCOUNT_NOT_FOUND: {
    userMessage:
      "We couldn't find your account. Please check your details and try again.",
    source: "user",
  },
  ...
  CREDENTIAL_ACCOUNT_NOT_FOUND: {
    userMessage:
      "We couldn't find your credential account. Please check and try again.",
    source: "user",
  },
  ...
  FAILED_TO_VERIFY_REGISTRATION: {
    userMessage:
      "We couldn't verify your registration. Please try again or contact support.",
    source: "server",
  },
  ...
  USER_NOT_FOUND: {
    userMessage:
      "We couldn't find your user account. Please check your details.",
    source: "user",
  },
  YOU_ARE_NOT_ALLOWED_TO_REGISTER_THIS_PASSKEY: {
    userMessage:
      "You're not authorized to register this passkey. Please contact support.",
    source: "passkey",
  },
...
export const getErrorMessage = (code: string, message?: string) => {
  ...
  return {
    userMessage:
      "It looks like there was an issue on our end. Please try again, and hopefully, things will be back to normal! If the problem continues, feel free to contact us, and we’ll look into it right away.",
    source: "server",
  };
};
