...
declare namespace NodeJS {
  ...
  interface ProcessEnv {
    ...
    COHERE_REQUEST_TIMEOUT_MS?: string;
    ...
    DURABLE_STREAMS_DATA_DIR?: string;
    DURABLE_STREAMS_LONG_POLL_TIMEOUT?: string;
    DURABLE_STREAMS_MAX_FILE_HANDLES?: string;
    DURABLE_STREAMS_PORT?: string;
    DURABLE_STREAMS_READ_BEARER_TOKEN?: string;
    DURABLE_STREAMS_READ_URL?: string;
    DURABLE_STREAMS_SERVER_VERSION?: string;
    DURABLE_STREAMS_URL?: string;
    DURABLE_STREAMS_WRITE_BEARER_TOKEN?: string;
    DURABLE_STREAMS_WRITE_URL?: string;
    EMAIL_FROM?: string;
    ...
    RETRIEVAL_ABSTENTION_SCORE?: string;
    ...
    RETRIEVAL_QUERY_EXPANSION_ENABLED?: string;
    RETRIEVAL_RERANK_CANDIDATE_LIMIT?: string;
    RETRIEVAL_RERANK_EXHAUSTIVE_LIMIT?: string;
