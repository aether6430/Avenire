ALTER TABLE "chat_thread" ADD COLUMN IF NOT EXISTS "branching" text;--> statement-breakpoint
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1
...
CREATE INDEX IF NOT EXISTS "chat_thread_branching_idx" ON "chat_thread" USING btree ("branching");
