...
| make repo easier to change correctly after refactor | `partial` | Many shells are slimmer, and [explorer.tsx](/Users/johnmacartew/Developer.nosync/aveniri/apps/web/src/components/files/explorer.tsx:1) is now down to `517` lines, but it remains the clearest structural hotspot. |
