...
| make repo easier to change correctly after refactor | `partial` | Many shells are slimmer, but [explorer.tsx](/Users/johnmacartew/Developer.nosync/aveniri/apps/web/src/components/files/explorer.tsx:1) is still `686` lines and remains the clearest structural hotspot. |
